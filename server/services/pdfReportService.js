  ...
  generateReport(auditData, userData, logoBuffer, competitors = []) {
    const doc = new PDFDocument({
      ...
      info: {
        ...
        Author: userData.companyName || "Seo Inspect Pro",
    ...
    safeText(userData.companyName || "Seo Inspect Pro", margin + 100, currentY + 25);
    ...
    doc.fontSize(10).fillColor(colors.gray600);
    safeText(`Report generated by ${userData.companyName || "Seo Inspect Pro"}`, margin + 20, currentY + 20, {
